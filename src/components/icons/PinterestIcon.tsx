...
export const PinterestIcon = (props: IconPropType) => (
  <svg
  ...
  >
    <g>
      <g>
        ...
        <g>
          <path
            d="M121.5,0C54.4,0,0,54.4,0,121.5C0,173,32,217,77.2,234.7c-1.1-9.6-2-24.4,0.4-34.9c2.2-9.5,14.2-60.4,14.2-60.4
